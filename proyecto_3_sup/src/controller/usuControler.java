...
public class usuControler {
    ...
    public usuControler(UsuarioImplementationDAO implemetacionDao, VentanaPrincipal ventana) {
        ...
        ventana.addBtnVerListener(new btnMostrarListener());
    ...
    class btnMostrarListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (filaSeleccionada != -1) {
                ...
                MostrarControler controller = new MostrarControler(vista, directorio);
                ventana.dispose();
            } else {
